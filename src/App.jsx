  ...
  return (
    <div className="sav-root">
      <style>{`
        ...
        .sav-card .service { font-size:11px; font-weight:600; margin:0 0 6px; text-transform:uppercase; letter-spacing:0.03em; }
      ...
      {view === "edit" && current && (
        <>
          <div className="sav-header">
            ...
            <div className="sav-header-right">
              <div className="sav-sync" title="La fiche s'enregistre automatiquement toutes les 20 secondes si le nom et le téléphone sont remplis">
                <span className={`sav-sync-dot ${autoSaving ? "spinning" : ""}`} />
                {autoSaving
                  ? "Sauvegarde..."
                  : lastAutoSave
                  ? `Sauvegardé ${formatAgo(lastAutoSave)}`
                  : "Sauvegarde auto"}
              </div>
              {current.ean14 && (
